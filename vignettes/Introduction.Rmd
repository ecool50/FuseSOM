...
```
From the plots, we see that the `Jump` statistics perfectly capture the number of clusters. The `Gap` method is a close second with $11$ clusters. All the other methods significantly underestimates the number of clusters.
