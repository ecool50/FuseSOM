...
# optimal number of clusters according to the discriminant method is 15
...
```
From the plots, we see that the `Jump` statistics almost perfectly capture the number of clusters. The `Gap` and `Discriminant` methods are a close second with $15$ clusters respectively. All the other methods significantly underestimates the number of clusters.
...
```
Again, we see that the `Jump` statistics almost perfectly capture the number of clusters. The `Gap` and `Discriminant` methods are a close second with $15$ clusters respectively. All the other methods significantly underestimates the number of clusters.
